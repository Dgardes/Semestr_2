...
CREATE TABLE `books` (
  ...
  PRIMARY KEY (`book_ID`),
  KEY `idx_b_cat_ID` (`b_cat_ID`),
  KEY `idx_b_name` (`b_name`),
  KEY `idx_b_price` (`b_price`),
...
CREATE TABLE `users` (
  ...
  `u_gender` enum('m','f') NOT NULL DEFAULT 'm',
  PRIMARY KEY (`user_ID`),
  KEY `idx_user_surname` (`u_surname`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Ћ«ҐЄб ­¤а','‚ «Ґа?©®ўЁз','?ў ­®ў','58-98-78','ivanov@gmail.com','active','m'),(2,'‘ҐаЈ?©','?ў ­®ўЁз','‹®бҐў','90-57-77','lo-sev@gmail.com','passive','m'),(3,'?Ј®а','ЊЁЄ®« ©®ўЁз','‘Ё¬®­®ў','95-66-61','si-monov@mail.ua','active','m'),(4,'Њ ЄбЁ¬','ЏҐва®ўЁз','Љг§­Ґж®ў',NULL,'kuz-netsov@mail.ua','active','m'),(5,'Ђ­ в®«?©','ћа?©®ўЁз','ЏҐва®ў',NULL,NULL,'lock','m'),(6,'Ћ«ҐЄб ­¤а','Ћ«ҐЄб ­¤а®ўЁз','Љ®а­ҐҐў','89-78-36','korneev@i.ua','gold','m'),(8,'Ћ«мЈ ','ЏҐва?ў­ ','”Ґ¤®а®ў ','53-56-58',NULL,'active','f'),(9,'?аЁ­ ','‚®«®¤Ё¬Ёа?ў­ ','‡®«®в®ў ',NULL,'zolotova@i.ua','gold','f');
...
-- Dump completed on 2026-05-10 19:53:50
